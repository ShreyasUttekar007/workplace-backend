...
const mumbaiCasteRoutes = require("./routes/mumbaiCastes");
...
const momFormatRoutes = require("./routes/momFormat");
const pcmReportRoutes = require("./routes/pcmReport");
...
app.use("/api/mumbai-caste", mumbaiCasteRoutes);
...
app.use("/api/mom-format", momFormatRoutes);
app.use("/api/pcm-report", pcmReportRoutes);
