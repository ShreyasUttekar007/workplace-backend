...
//     // Check the roles against the predefined arrays
...
//     console.log("userParliamentaryConstituencyRoles::: ", userParliamentaryConstituencyRoles);
...
//               parliamentaryConstituency: { $in: userParliamentaryConstituencyRoles },
//             }).populate("userId");
//           } else {
//             moms = await Mom.find({
//               zone: { $in: userZoneRoles },
...
//           }).populate("userId");
//         }
//       } else if (userParliamentaryConstituencyRoles.length > 0) {
//         moms = await Mom.find({
//           zone: { $in: userZoneRoles },
//           parliamentaryConstituency: { $in: userParliamentaryConstituencyRoles },
//         }).populate("userId");
